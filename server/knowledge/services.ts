...
export const SERVICE_KNOWLEDGE: readonly KnowledgeEntry[] = [
  {
    ...
    aliases: ['AR機能', 'マーカー機能', '名刺で何ができる', '名刺で何ができますか', 'ペンギンロゴ'],
    keywords: ['AR', 'マーカー', '名刺', 'ペンギン', 'カメラ'], sourceIds: ['readme'], visibility: 'public', reviewedAt,
  },
  {
    ...
    keywords: ['アバター', '3D', 'VRM', 'モーション', '感情'], sourceIds: ['readme'], visibility: 'public', reviewedAt,
  },
  {
  ...
  },
  {
    ...
    keywords: ['Calendar', 'カレンダー', '予定', '空き時間', '公開'], sourceIds: ['calendar-policy'], visibility: 'public', reviewedAt,
  },
] as const;
