...
export const COMPANY_KNOWLEDGE: readonly KnowledgeEntry[] = [
  {
    ...
    answer: 'Cor.Inc.は福岡を拠点とするソフトウェア開発スタートアップです。このアプリでは、名刺マーカーを使ったAR技術デモを公開しています。',
    aliases: ['会社について', 'Cor.Inc.とは', 'コアインクとは', 'どんな会社'],
    keywords: ['Cor.Inc', '会社', '福岡', 'ソフトウェア', 'スタートアップ'], sourceIds: ['project-summary'], visibility: 'public', verifiedAt,
  },
  {
    ...
    keywords: ['クラウディア', 'キャラクター', 'アンバサダー', '博多弁'], sourceIds: ['readme', 'runtime-contract'], visibility: 'public', verifiedAt,
  },
  {
    ...
    keywords: ['目的', 'デモ', '企業', 'パートナー', '技術体験'], sourceIds: ['project-summary'], visibility: 'public', verifiedAt,
  },
] as const;
